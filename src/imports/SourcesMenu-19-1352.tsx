import svgPaths from "./svg-wbm4z3eu6p";
...
function Place() {
  return (
    <div className="box-border content-stretch flex gap-[2px] items-center pb-0 pt-[2px] px-0 relative shrink-0" data-name="Place">
      <p className="-webkit-box css-gtcsq9 font-['Inter:Medium',_sans-serif] font-medium leading-[20px] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[15px] text-neutral-900 text-nowrap whitespace-pre">Kumiko</p>
    </div>
  );
}
