import svgPaths from "./svg-elbe2oos1n";
...
function TableTonightChips() {
  return (
    <div className="bg-[#f7f4ed] box-border content-stretch flex gap-[6px] h-[36px] items-center justify-center overflow-clip px-[12px] py-0 relative rounded-[10px] shrink-0" data-name="Table Tonight Chips">
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[14px] text-[rgba(23,23,23,0.6)] text-nowrap whitespace-pre">No matching tables</p>
    </div>
  );
}

function TableTonightChips1() {
  return (
    <div className="bg-[#f7f4ed] box-border content-stretch flex gap-[6px] h-[36px] items-center justify-center overflow-clip px-[12px] py-0 relative rounded-[10px] shrink-0" data-name="Table Tonight Chips">
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[14px] text-neutral-900 text-nowrap whitespace-pre">See upcoming dates</p>
    </div>
  );
}
